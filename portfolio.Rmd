...
+ Message: To show that during an incidental category learning, item representations are stronger that category representations. I suggest you use some version of this text as a plot title. -MSC 
...
ggplot(mdl, aes(x = term, y = estimate)) +
  ...
  geom_point( color = "#6E6E6E", size = 5) + #added bigger point to draw the eye; don't know how to make the colors align
